...
public class UtilisateurManagementService {
    ...
    public ReqRes register(ReqRes registrationRequest){
        ...
        try {
            ...
            utilisateur.setCity(registrationRequest.getCity());
            utilisateur.setRole(registrationRequest.getRole());
            utilisateur.setName(registrationRequest.getName());
            utilisateur.setPassword(passwordEncoder.encode(registrationRequest.getPassword()));
            utilisateur ourUsersResult = utilisateurRepository.save(utilisateur);
            if (ourUsersResult.getId()>0) {
                resp.setUtilisateur((utilisateurResult));
    ...
    public ReqRes getAllUsers() {
        ...
        try {
            ...
            if (!result.isEmpty()) {
                reqRes.setUtilisateurList(result);
