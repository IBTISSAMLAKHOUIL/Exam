...
import com.usermanagement.service.UsersManagementService;
...
public class UserManagementController {
    ...
    public ResponseEntity<ReqRes> confirmEmail(@RequestParam String token) {
        ReqRes response = usersManagementService.confirmEmail(token);
